  ...
  useEffect(() => {
    getData().then((newData) => {
      if (!newData || JSON.stringify(newData) === '{}' || JSON.stringify(newData) === '[]') {
        newData = [
          { id: 1, nome: "Pessoa 1", endereco: "endereco", contato: "contato", categoria: "categoria" },
          { id: 2, nome: "Teste Novo", endereco: "SQN 311 Bloco C", contato: "112233445", categoria: "teste" }];
      }
      setData(newData);
    });
  }, [])
